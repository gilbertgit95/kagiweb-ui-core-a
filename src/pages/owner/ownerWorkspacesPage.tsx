...
import UserWorkspacesReadOnlyView from '../userWorkspace/userWorkspacesReadOnlyView';
                ...
                <Grid item xs={6} style={{alignContent: 'right'}}>
                    <Box
                        ...
                        <Button
                            variant="text"
                            startIcon={<AddIcon />}
                            onClick={() => navigate(`/owner/create/workspaces`)}>
                            Create
                        </Button>
                    </Box>
                </Grid>
...
export default OwnerWorkspacesPage