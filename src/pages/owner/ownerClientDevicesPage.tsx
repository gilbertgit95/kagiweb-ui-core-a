...
import UserClientDevicesReadOnlyView from '../userClientDevice/userClientDevicesReadOnlyView';
                ...
                <Grid item xs={6} style={{alignContent: 'right'}}>
                    <Box
                        ...
                        <Button
                            variant="text"
                            startIcon={<AddIcon />}
                            onClick={() => navigate(`/owner/create/clientDevices`)}>
                            Create
                        </Button>
                    </Box>
                </Grid>
...
export default OwnerClientDevicesPage