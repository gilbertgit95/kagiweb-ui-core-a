...
import AccountAccountConfigReadOnlyView from '../accountAccountRefAccountConfig/accountAccountRefAccountConfigReadOnlyView';
    ...
    return (
        <Container style={{paddingTop: 20}}>
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <PrimaryHeader title={'Owner Account Ref Config Readonly View'} subtitle={ account?.nameId } />
                    <Divider />
                </Grid>
                <Grid item xs={6}>
                    <Button
                ...
                <Grid item xs={6} style={{alignContent: 'right'}}>
                    <Box
                        ...
                        <Button
                            ...
                            onClick={() => navigate(`/owner/edit/accountRefs/${ accountRefId }/accountConfigs/${ accountConfigId }`)}>
                            Edit
                        </Button>
                    </Box>
                </Grid>
