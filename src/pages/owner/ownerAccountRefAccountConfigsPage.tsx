...
import AccountAccountConfigsReadOnlyView from '../accountAccountRefAccountConfig/accountAccountRefAccountConfigsReadOnlyView';
    ...
    return (
        <Container style={{paddingTop: 20}}>
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <PrimaryHeader title={'Owner Account Ref Configs View'} subtitle={ account?.nameId } />
                    <Divider />
                </Grid>
                <Grid item xs={12}>
                    <Button
