                ...
                <Grid item xs={6} style={{alignContent: 'right'}}>
                    <Box
                        ...
                        <Button
                            ...
                            disabled={ !accountRef }
                            onClick={() => navigate(`/accounts/view/${ accountRef?.accountId }/actions/invitation/module/accounts/${ accountId }/subModule/workspace/${ workspaceId }/ref/accountRefs/${ accountRefId }`)}>
                            View Invitation
                        </Button>
                        <Button
                            variant="text"
