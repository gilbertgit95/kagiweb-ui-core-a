...
import AccountAccountConfigsReadOnlyView from './accountAccountConfigsReadOnlyView';

const AccountAccountConfigsPage = () => {
...
export default AccountAccountConfigsPage