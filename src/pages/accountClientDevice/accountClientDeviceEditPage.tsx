...
import AccountClientDeviceEditForm from './accountClientDeviceEditForm';
    ...
    return (
        <Container style={{paddingTop: 20}}>
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <PrimaryHeader title={'Client Device Update View'} subtitle={ account?.username } />
                    <Divider />
                </Grid>
                <Grid item xs={12}>
                    <Button
                ...
                <AccountClientDeviceEditForm
                    ...
                    updateFunc={AccountClientDeviceService.updateClientDevice}
                    updated={onUpdated} />
