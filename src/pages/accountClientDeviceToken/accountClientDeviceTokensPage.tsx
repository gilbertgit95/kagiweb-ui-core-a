    ...
    return (
        <Container style={{paddingTop: 20}}>
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <PrimaryHeader title={'Account Client Device Tokens View'} subtitle={ account?.nameId } />
                    <Divider />
                </Grid>
                <Grid item xs={6}>
                    <Button
                ...
                <Grid item xs={6} style={{alignContent: 'right'}}>
                    <Box
                        ...
                        <Button
                            variant="text"
                            startIcon={<AddIcon />}
                            onClick={() => navigate(`/accounts/create/${ accountId }/clientDevices/${ clientDeviceId }/clientDeviceTokens`)}>
                            Create
                        </Button>
                    </Box>
                </Grid>
